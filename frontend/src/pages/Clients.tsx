...
function ClientCard({ client, onEdit, onDelete }: { client: Client; onEdit: () => void; onDelete: () => void }) {
  ...
  return (
    <Card
      sx={{
        bgcolor: "#1E1E1E", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 2,
...
export default function Clients() {
  ...
  return (
    <Box>
      ...
      <Dialog open={open} onClose={() => setOpen(false)} slotProps={{ paper: { sx: { bgcolor: "#1E1E1E", color: "white", minWidth: 480 } } }}>
