...
export default function ComplianceEvaluation() {
  ...
  return (
    <Box>
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 2, flexWrap: "wrap", gap: 2 }}>
        <Box>
          <Typography variant="h5" sx={{ color: "text.primary", fontWeight: 700 }}>Compliance Evaluation</Typography>
          <Typography variant="body2" sx={{ color: "text.secondary" }}>
            Evaluate compliance posture and run targeted scans against any framework
          </Typography>
        </Box>
