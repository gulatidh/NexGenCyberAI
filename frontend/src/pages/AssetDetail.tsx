...
const CLASS_COLOR: Record<string, string> = {
  vm: "#00e5ff", storage: "#ff9800", network: "#7c4dff", database: "#00e676",
    ...
    <Box>
      ...
      <Grid container spacing={2} sx={{ mb: 3 }}>
        <Grid size={{ xs: 12, sm: 4 }}>
          <Card sx={{ bgcolor: "#161b22", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 2, p: 2 }}>
      ...
      {/* Metadata grid */}
      <Card sx={{ bgcolor: "#161b22", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 2, p: 2, mb: 3 }}>
                  ...
                  {findings.map((f) => {
                    ...
                    return (
                      <TableRow key={f.id} sx={{ "& td": { borderColor: "rgba(255,255,255,0.05)", py: 1 } }}>
                        ...
                        <TableCell sx={{ color: f.cve_id ? "#00e5ff" : "rgba(255,255,255,0.3)", fontSize: 12 }}>{f.cve_id || "—"}</TableCell>
