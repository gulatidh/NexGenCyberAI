...
const STAGE_DEFS: StageDef[] = [
  {
    ...
    cards: [
      ...
      { name: "Integrations",  desc: "Platform connectors, scanners, AI providers, webhooks, and API keys — all in one hub.", route: "/platform/integrations", group: "Environment" },
      { name: "Ticket Sync",   desc: "Bi-directional sync of findings and remediations with your ticket system.",             route: "/platform/ticket-sync",  group: "Environment" },
      { name: "Risk Appetite", desc: "Configure organisation risk tolerance bands for the 5×5 GCC IM8 matrix.",              route: "/analyse/risk-appetite", group: "Governance Config" },
      { name: "Data Model",    desc: "Platform ontology — eleven entities, one interactive graph.",                          route: "/data-model",            group: "Governance Config" },
      { name: "Settings",      desc: "User preferences, deleted accounts, and platform configuration.",                      route: "/platform/settings",     group: "Governance Config" },
      { name: "Help",          desc: "Documentation, setup guides, and platform support resources.",                         route: "/platform/help",         group: "Governance Config" },
    ],
  },
  {
    ...
    cards: [
      { name: "Inbuilt Scanners",       desc: "Platform-native scanners — DAST, SAST, network, container, and secret scanning.",        route: "/discover/inbuilt",       group: "Security Scanners" },
      { name: "Enterprise Integration", desc: "Connect enterprise scanners — Tenable, Burp, Snyk, Rapid7, Qualys, Invicti, Acunetix.", route: "/discover/enterprise",    group: "Security Scanners" },
      { name: "Import Result",          desc: "Import external scan results from SARIF, Nessus, Burp, OpenVAS, Qualys, and more.",      route: "/discover/import-result", group: "Security Scanners" },
      { name: "AI Assisted Scan",       desc: "Conversational guided assessment — describe the environment, AI configures.",             route: "/discover/ai-scan",       group: "Security Scanners" },
      { name: "Findings",               desc: "All findings with severity, CVE enrichment, and remediation status.",                   route: "/discover/findings",      group: "Findings & Coverage" },
      { name: "CVE Blast Radius",       desc: "Map CVE exposure across assets — which assets are actually affected.",                  route: "/discover/cve-pivot",     group: "Findings & Coverage" },
  ...
  },
  {
    ...
    cards: [
      { name: "Risk Staging",      desc: "AI / finding / manual proposals — 8-step evaluation wizard before the register.",    route: "/analyse/risks/staging",      group: "Risk" },
      ...
      { name: "Attack Paths",      desc: "MITRE-phased attack chain graph derived from live findings.",                        route: "/analyse/attack-paths",       group: "Exposure & Threat Modelling" },
      { name: "Threat Models",     desc: "DFD diagrams, STRIDE threats, and Sigma detection rule generation.",                 route: "/analyse/threat-models",      group: "Exposure & Threat Modelling" },
      { name: "Compliance Heatmap",desc: "Control coverage heatmap across all active frameworks.",                             route: "/analyse/compliance-heatmap", group: "Exposure & Threat Modelling" },
      { name: "Ask Your Data",     desc: "Natural language SQL queries over findings, risks, and assets.",                     route: "/analyse/nl-query",           group: "Query & Compare" },
      { name: "Comparison",        desc: "Compare security posture side-by-side across multiple accounts.",                    route: "/analyse/comparison",         group: "Query & Compare" },
    ],
  },
  {
    ...
    cards: [
      { name: "Incidents",       desc: "Security incident cases with timelines, owners, SLA tracking, and linked findings.", route: "/respond/incidents",        group: "Incidents" },
  ...
  },
  {
    ...
    cards: [
      { name: "VAPT Reports",          desc: "Full engagement lifecycle with retest versioning and PDF/DOCX export.",               route: "/report/vapt-reports",      group: "Reporting" },
      { name: "Evidence Package",      desc: "Audit-ready ZIP of findings, deficiencies, and agent logs for auditors.",             route: "/report/evidence",          group: "Reporting" },
      { name: "Reports",               desc: "AI-generated security posture and trend reports.",                                   route: "/report/reports",           group: "Reporting" },
      { name: "Executive Summary",     desc: "Non-technical leadership report — posture score, key risks, and remediation progress.", route: "/report/executive-summary", group: "Reporting" },
      { name: "Report Scheduler",      desc: "Schedule recurring report delivery to stakeholders via email.",                       route: "/report/scheduler",         group: "Reporting" },
      { name: "Audit Intelligence",    desc: "ICS Audit & Risk — how every audit activity maps to the platform.",                  route: "/report/audit",             group: "Audit Operations" },
      { name: "Audit Agents",          desc: "Wizard-driven AI agents for control testing, readiness reports, and evidence curation.", route: "/report/audit-agents",   group: "Audit Operations" },
      { name: "Audit Logs",            desc: "LLM prompt audit trail — per-user, per-endpoint, with CSV export.",                  route: "/platform/audit-logs",      group: "Audit Operations" },
      { name: "Framework Library",     desc: "Browse standard frameworks and manage custom compliance policies.",                   route: "/report/frameworks",        group: "Compliance Frameworks" },
  ...
  },
  {
    ...
    cards: [
      ...
      { name: "AI Assisted Review", desc: "Select a completed assessment and let AI recommend which agents to run next.",        route: "/automate/ai-review",                 group: "AI Agents" },
      ...
      { name: "Webhooks",           desc: "Event-driven alerts on critical findings and completed scans.",                      route: "/platform/integrations?tab=webhooks", group: "Governance" },
      { name: "API Keys",           desc: "M2M API keys for CI/CD pipelines and programmatic access.",                         route: "/platform/integrations?tab=api-keys", group: "Governance" },
      { name: "AI Usage & Cost",    desc: "Token consumption and estimated spend per provider and agent.",                      route: "/automate/usage",                     group: "Governance" },
    ],
  },
];
