...
const STAGE_DEFS: StageDef[] = [
  {
    ...
    cards: [
      ...
      { name: "Audit Logs",     desc: "LLM prompt audit trail — per-user, per-endpoint, with CSV export.",                       route: "/platform/audit-logs",    group: "Design" },
  ...
  },
  {
    ...
    cards: [
      ...
      { name: "Findings",               desc: "All findings with severity, CVE enrichment, and remediation status.",                   route: "/discover/findings",      group: "Vulnerability Findings" },
      { name: "AI Assisted Scan",       desc: "Conversational guided assessment — describe the environment, AI configures.",            route: "/discover/ai-scan",       group: "Vulnerability Findings" },
  ...
  },
  {
    ...
    cards: [
      ...
      { name: "Risk Appetite",      desc: "Configure organisation risk tolerance bands for the 5×5 GCC IM8 matrix.",       route: "/analyse/risk-appetite",      group: "Risk" },
      { name: "Attack Paths",       desc: "MITRE-phased interactive attack chain graph derived from live findings.",        route: "/analyse/attack-paths",       group: "Vulnerability" },
      { name: "Compliance Heatmap", desc: "Control coverage heatmap across all active frameworks.",                        route: "/analyse/compliance-heatmap", group: "Vulnerability" },
      { name: "CVE Blast Radius",   desc: "Map CVE exposure across assets — which assets are actually affected.",          route: "/discover/cve-pivot",         group: "Vulnerability" },
      { name: "Scan Coverage",      desc: "Assets not scanned within the policy window — identify coverage gaps.",         route: "/discover/coverage",          group: "Vulnerability" },
      { name: "Threat Model",       desc: "DFD diagrams, STRIDE threats, and Sigma detection rule generation.",            route: "/analyse/threat-models",      group: "Intelligence" },
      { name: "Posture Trends",     desc: "Time-series charts of open findings and audit readiness score.",                route: "/discover/posture",           group: "Intelligence" },
  ...
  },
  {
    ...
    cards: [
      ...
      { name: "Custom Standards",      desc: "Build your own control framework from existing platform controls.",                             route: "/report/custom-frameworks",   group: "Compliance" },
