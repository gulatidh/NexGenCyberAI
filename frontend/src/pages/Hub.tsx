...
const STAGE_DEFS: StageDef[] = [
  ...
  },
  {
    ...
    cards: [
      ...
      { name: "Evidence Package",      desc: "Audit-ready ZIP of findings, deficiencies, and agent logs for auditors.",    route: "/report/evidence",            group: "Pen Testing" },
      { name: "Audit Intelligence",    desc: "ICS Audit & Risk — how every audit activity maps to the platform.",          route: "/report/audit",               group: "Pen Testing" },
      { name: "Executive Summary",     desc: "Non-technical leadership report — posture score, key risks, and remediation progress.", route: "/report/executive-summary", group: "Pen Testing" },
      { name: "Reports",               desc: "AI-generated security posture and trend reports.",                           route: "/report/reports",             group: "Pen Testing" },
      { name: "Report Scheduler",      desc: "Schedule recurring report delivery to stakeholders via email.",              route: "/report/scheduler",           group: "Pen Testing" },
