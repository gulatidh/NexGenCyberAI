          ...
          <Card variant="outlined">
            <CardContent>
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                {[
                  ["Application", "Aegis AI — NexGenCyberAI"],
                  ["Version", "1.0"],
  ...
  return (
    <Box>
      ...
      <Alert severity="info" sx={{ mb: 2.5 }}>
        These settings control which Azure AD tenant Aegis authenticates against. Changes take effect after the application is restarted or redeployed.
      </Alert>
          ...
          <Grid container spacing={2}>
            ...
            <Grid size={{ xs: 12, sm: 6 }}>
              <TextField fullWidth size="small" label="Client ID (App Registration)" placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
                ...
                helperText="Application (client) ID of the Aegis app registration"
