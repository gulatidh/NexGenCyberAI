...
const ALL_SCANNER_TYPES = new Set<ConnectorType>([
  "web", "semgrep", "codeql", "nmap", "openvas", "trivy", "owasp_dc", "gitleaks", "trufflehog",
...
export const CREDENTIAL_FIELDS: Record<ConnectorType, CredField[]> = {
  ...
  openvas: [
    ...
    { key: "gvm_socket_path", label: "GVM Socket Path (optional)", placeholder: "/run/gvmd/gvmd.sock",
      help: "Leave blank — auto-detected. Set only if your gvmd socket is in a non-standard location." },
    { key: "gvm_host",        label: "GVM Host (TLS fallback)", placeholder: "127.0.0.1",
