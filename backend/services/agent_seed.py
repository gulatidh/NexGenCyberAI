...
_CATALOG: List[Dict[str, Any]] = [
    ...
    {"key": "configuration_review", "name": "Configuration Review", "group_key": "operational", "group_label": "Operational",
     "description": "Pulls raw cloud asset configurations from a selected platform connector and runs an AI security review, identifying misconfigurations, IAM over-privilege, unencrypted storage, and missing controls.",
     ...
     "legacy_orchestrator": True,
     "input_schema": [
         {"type": "platform_data", "label": "Platform connector *", "required": True,
          "description": "Select the cloud platform connector whose asset configurations you want to review. Only connectors with a completed scan are supported."},
         {"type": "framework", "label": "Compliance framework", "required": False,
          "description": "Optional: map findings to a specific compliance framework."},
     ],
